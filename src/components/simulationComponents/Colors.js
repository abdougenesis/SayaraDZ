...
import ColorsTest from "./../managComponents/ManagColorComps/ColorsTest";
...
class Colors extends Component {
  ...
  componentDidMount() {
    this.setState(oldstate => {
      const newColors = oldstate.allColors.map(color => {
        color.selected = false;
        return color;
      });
      return { allColors: newColors };
    });
  }
  ...
  handleChange = code => {
    this.setState(oldstate => {
      const newColors = oldstate.allColors.map(color => {
        if (color.Code_Couleur === code) color.selected = true;
          ...
          return (
            ...
            >
              ...
              <div className="carSimulation">
                ...
                <div className="circleSimulation" />
              </div>
              <div className="simulerColorsContainer">{allColors}</div>
              <div className="validerContainerSimulation">
